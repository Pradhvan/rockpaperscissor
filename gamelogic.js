...
// Returns choice selected by computer
...
//computation to decide the winner.
function playRound(playerSelection, computerSelection) {
  ...
  ((playerSelection=="rock") && (computerSelection=="scissors"))){
      playerscore++;
      result = `You selected ${playerSelection} and Computer selected ${computerSelection}!. YOU win!`;
      return result;
  ...
  ((playerSelection=="paper")&&(computerSelection=="scissors"))){
    computerscore++;
    result = `You selected ${playerSelection} and Computer selected ${computerSelection}!. Computer wins!`;
    return result;
  } else if (playerSelection == computerSelection) {
    result = `You and the computer selected ${computerSelection}!. Match Draw!`;
    return result;
}
}
